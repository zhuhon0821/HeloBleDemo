...
public struct GnssDataModel:Equatable,Codable,TableRecord, FetchableRecord, PersistableRecord {
   
    var data_from: String
    var date: Date
    var _longitude: Float? = nil
    var _latitude: Float? = nil
    var _speed: Float? = nil
    var _altitude: Float? = nil
    init(data_from: String, date: Date, _longitude: Float? = nil, _latitude: Float? = nil, _speed: Float? = nil, _altitude: Float? = nil) {
        self.data_from = data_from
        self.date = date
