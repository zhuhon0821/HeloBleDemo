...
public struct DeviceBaseInfo {
    ...
    var mac:String?
    var sn:String?
    init(model: String? = nil, version: String? = nil, mac: String? = nil, sn: String? = nil) {
        self.model = model
...
struct HealthDataItemSupport {
    var supportRtTime:Bool
    var supportRtBattery:Bool
    var supportRtHealth:Bool
    var supportHisHealth:Bool
    var supportHisGnss:Bool
    var supportHisEcg:Bool
    var supportHisPpg:Bool
    var supportHisRri:Bool
    var supportHisSpo2:Bool
    init(supportRtTime: Bool, supportRtBattery: Bool, supportRtHealth: Bool, supportHisHealth: Bool, supportHisGnss: Bool, supportHisEcg: Bool, supportHisPpg: Bool, supportHisRri: Bool, supportHisSpo2: Bool) {
        self.supportRtTime = supportRtTime
        self.supportRtBattery = supportRtBattery
        self.supportRtHealth = supportRtHealth
        self.supportHisHealth = supportHisHealth
        self.supportHisGnss = supportHisGnss
        self.supportHisEcg = supportHisEcg
        self.supportHisPpg = supportHisPpg
        self.supportHisRri = supportHisRri
        self.supportHisSpo2 = supportHisSpo2
    }
}
struct CVibrateCnf {
...
struct CHealthDataConfig {
    ...
    var apgConfig:Bool?
    init(ecgConfig: Bool? = nil, fatigueConfig: Bool? = nil, bpConfig: Bool? = nil, afConfig: Bool? = nil, biozConfig: Bool? = nil, moodConfig: Bool? = nil, breathrateConfig: Bool? = nil, mdtConfig: Bool? = nil, spo2Config: Bool? = nil, temperatureConfig: Bool? = nil, apgConfig: Bool? = nil) {
