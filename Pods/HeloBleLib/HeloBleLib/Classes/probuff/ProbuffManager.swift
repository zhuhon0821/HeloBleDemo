...
class ProbuffManager: CmdManager {
    public static var sharedInstance:ProbuffManager? = nil
    public var mtu:Int = 20
    public var maxCalendarCount:UInt32 = 6
    var _max_sedt_count:Int = 3
    public var healthDataItemSupport:HealthDataItemSupport?
    public var deviceMode:String = ""
    public var fota:DevInfoFota?
    
    public override func syncHealthData() {
        read80HistoryDataIndexTable(.healthData)
    }
    ...
    public override func readSupportHealthItemsForDevice() {
        read09DataInformation()
    }
    private func read09DataInformation() {
        var diR = DataInfoRequest()
        diR.reserved = 123
        if let data = try?diR.serializedData() {
            writeCharacteristicByPBOpt(optCode: .PB_Opt_DataInfo, payload: data)
        }
    }
    ...
    public override func setDateTimeConf(_ date:Date) {
        ...
        var rtTime = RtTime()
        rtTime.seconds = UInt32(arc4random())
    ...
    public override func setBloodPresureConf(_ cbpCaliConf:CBpCaliConf) {
        ...
        bpCaliConf.hash = UInt32(arc4random())
    ...
    public override func setHrAlarmConf(_ chrAlarmConf:CHrAlarmConf) {
        ...
        hrAlarmConf.hash = UInt32(arc4random())
    ...
    public override func setGoalConf(_ cgoalConf:CGoalConf) {
        ...
        goalConf.hash = UInt32(arc4random())
    ...
    public override func setGnssConf(_ cgnssConf:CGnssConf) {
        ...
        gnssConf.hash = UInt32(arc4random())
    ...
    public override func setAlarmClocks(_ calarmClocks:[CAlarmClock]) {
        ...
        alarmGroup.hash = UInt32(arc4random())
    ...
    public override func setDeviceOption(_ cNotification:CDeviceConfNotification) {
       var deviceConfNotification = DeviceConfNotification()
        ...
        if let cheathConfig = cNotification.heathConfig {
            ...
            if let apgConfig = cheathConfig.apgConfig {
                heathConfig.apgConfig = apgConfig
            }
        ...
        deviceConfNotification.hash = UInt32(arc4random())
    ...
    public override func setMotors(_ motors:[CVibrateCnf]) {
        ...
        motorConf.hash = UInt32(arc4random())
    ...
    /**
       upgrade firmware
     */
    public override func writeUpgradeCmdA(_ peripheral:CBPeripheral) {
    ...
    /**
       upgrade firmware
     */
    public override func writeUpgradeCmdB(_ peripheral:CBPeripheral) {
...
extension ProbuffManager {
    ...
    func getRealTimeDataSubscriber(_ rtDSB:RTDataSbscrbr,_ isRunInBackground:Bool) -> Data? {
        ...
        switch (rtDSB) {
            ...
            if ProbuffManager.sharedInstance?.fota == .ats3085Ble {
                    rtSMArr[3] = RtMode.breathMeasure;
                } else {
                //与心率同一条命令
                    rtSMArr[3] = RtMode.hrMeasure;
                }
...
extension ProbuffManager {
    func appendWriteData(optCode:PB_Opt,payload:Data) -> Data {
        ...
        let crcCode = ProbuffDataHandle.sharedInstance.calcCrc16(data: payload, len: UInt(payload.count))
