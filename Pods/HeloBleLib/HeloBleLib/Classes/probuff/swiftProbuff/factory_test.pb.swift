...
enum FactoryTestMode: SwiftProtobuf.Enum, Swift.CaseIterable {
...
enum TestOperation: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case testStart // = 0
  case testStop // = 1
  case testResult // = 2
...
enum FACTORY_PAGE_TEST: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case motor // = 0
...
struct PlacementTestResult: Sendable {
...
struct ChargeTestResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct DischargeTestResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct PressureTestResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct AutoTestResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SensorTestResult: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Test_temprature: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Test_diff0_data: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Test_Air_pressure: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Test_pah8009_leak: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Test_gh3xxx_hr_leak: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Test_pah831x_leak: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Test_hrs3600_leak: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Test_hx3918_leak: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Test_bp_upressure: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Test_cover_gsm_info: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var imeiStr: String {
    get {return _imeiStr ?? String()}
    set {_imeiStr = newValue}
  }
  /// Returns true if `imeiStr` has been explicitly set.
  var hasImeiStr: Bool {return self._imeiStr != nil}
  /// Clears the value of `imeiStr`. Subsequent reads from it will return its default value.
  mutating func clearImeiStr() {self._imeiStr = nil}

  var deviceSecret: String {
    get {return _deviceSecret ?? String()}
    set {_deviceSecret = newValue}
  }
  /// Returns true if `deviceSecret` has been explicitly set.
  var hasDeviceSecret: Bool {return self._deviceSecret != nil}
  /// Clears the value of `deviceSecret`. Subsequent reads from it will return its default value.
  mutating func clearDeviceSecret() {self._deviceSecret = nil}

  var imsxmlVersion: Int32 {
    get {return _imsxmlVersion ?? 0}
    set {_imsxmlVersion = newValue}
  }
  /// Returns true if `imsxmlVersion` has been explicitly set.
  var hasImsxmlVersion: Bool {return self._imsxmlVersion != nil}
  /// Clears the value of `imsxmlVersion`. Subsequent reads from it will return its default value.
  mutating func clearImsxmlVersion() {self._imsxmlVersion = nil}

  var gid1Str: String {
    get {return _gid1Str ?? String()}
    set {_gid1Str = newValue}
  }
  /// Returns true if `gid1Str` has been explicitly set.
  var hasGid1Str: Bool {return self._gid1Str != nil}
  /// Clears the value of `gid1Str`. Subsequent reads from it will return its default value.
  mutating func clearGid1Str() {self._gid1Str = nil}

  var spnStr: String {
    get {return _spnStr ?? String()}
    set {_spnStr = newValue}
  }
  /// Returns true if `spnStr` has been explicitly set.
  var hasSpnStr: Bool {return self._spnStr != nil}
  /// Clears the value of `spnStr`. Subsequent reads from it will return its default value.
  mutating func clearSpnStr() {self._spnStr = nil}

  var imsiStr: String {
    get {return _imsiStr ?? String()}
    set {_imsiStr = newValue}
  }
  /// Returns true if `imsiStr` has been explicitly set.
  var hasImsiStr: Bool {return self._imsiStr != nil}
  /// Clears the value of `imsiStr`. Subsequent reads from it will return its default value.
  mutating func clearImsiStr() {self._imsiStr = nil}
  ...
  fileprivate var _imeiStr: String? = nil
  fileprivate var _deviceSecret: String? = nil
  fileprivate var _imsxmlVersion: Int32? = nil
  fileprivate var _gid1Str: String? = nil
  fileprivate var _spnStr: String? = nil
  fileprivate var _imsiStr: String? = nil
}

struct FactoryTestNotify: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct FactoryTestConfim: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var coverGsmInfo: Test_cover_gsm_info {
    get {
      if case .coverGsmInfo(let v)? = _storage._params {return v}
      return Test_cover_gsm_info()
    }
    set {_uniqueStorage()._params = .coverGsmInfo(newValue)}
  }
  ...
  enum OneOf_Params: Equatable, Sendable {
    ...
    case coverGsmInfo(Test_cover_gsm_info)
    ...
    fileprivate var isInitialized: Bool {
      ...
      case .coverGsmInfo: return {
        guard case .coverGsmInfo(let v) = self else { preconditionFailure() }
        return v.isInitialized
      }()
      default: return true
      }
...
extension Test_cover_gsm_info: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "Test_cover_gsm_info"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "Revision"),
    2: .standard(proto: "IMEI_str"),
    3: .standard(proto: "device_secret"),
    4: .standard(proto: "imsxml_version"),
    5: .standard(proto: "GID1_str"),
    6: .standard(proto: "SPN_str"),
    7: .standard(proto: "IMSI_str"),
  ]

  public var isInitialized: Bool {
    if self._revision == nil {return false}
    if self._imeiStr == nil {return false}
    if self._deviceSecret == nil {return false}
    if self._imsxmlVersion == nil {return false}
    if self._gid1Str == nil {return false}
    if self._spnStr == nil {return false}
    if self._imsiStr == nil {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self._imeiStr) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self._deviceSecret) }()
      case 4: try { try decoder.decodeSingularSFixed32Field(value: &self._imsxmlVersion) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self._gid1Str) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self._spnStr) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self._imsiStr) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._imeiStr {
      try visitor.visitSingularStringField(value: v, fieldNumber: 2)
    } }()
    try { if let v = self._deviceSecret {
      try visitor.visitSingularStringField(value: v, fieldNumber: 3)
    } }()
    try { if let v = self._imsxmlVersion {
      try visitor.visitSingularSFixed32Field(value: v, fieldNumber: 4)
    } }()
    try { if let v = self._gid1Str {
      try visitor.visitSingularStringField(value: v, fieldNumber: 5)
    } }()
    try { if let v = self._spnStr {
      try visitor.visitSingularStringField(value: v, fieldNumber: 6)
    } }()
    try { if let v = self._imsiStr {
      try visitor.visitSingularStringField(value: v, fieldNumber: 7)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Test_cover_gsm_info, rhs: Test_cover_gsm_info) -> Bool {
    if lhs._revision != rhs._revision {return false}
    if lhs._imeiStr != rhs._imeiStr {return false}
    if lhs._deviceSecret != rhs._deviceSecret {return false}
    if lhs._imsxmlVersion != rhs._imsxmlVersion {return false}
    if lhs._gid1Str != rhs._gid1Str {return false}
    if lhs._spnStr != rhs._spnStr {return false}
    if lhs._imsiStr != rhs._imsiStr {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension FactoryTestConfim: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    34: .standard(proto: "cover_gsm_info"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 34: try {
          var v: Test_cover_gsm_info?
          var hadOneofValue = false
          if let current = _storage._params {
            hadOneofValue = true
            if case .coverGsmInfo(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._params = .coverGsmInfo(v)
          }
        }()
        default: break
        }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .coverGsmInfo?: try {
        guard case .coverGsmInfo(let v)? = _storage._params else { preconditionFailure() }
