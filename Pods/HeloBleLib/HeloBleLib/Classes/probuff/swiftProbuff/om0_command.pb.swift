...
enum Mc30Powermode: SwiftProtobuf.Enum, Swift.CaseIterable {
...
enum GPSTYPE: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case null // = 0
  case typeBts // = 1
  case typeWifi // = 2
...
struct OM0TrackConf: Sendable {
  ...
  var gpsLocatesEveryTime: Bool {
    get {return _gpsLocatesEveryTime ?? false}
    set {_gpsLocatesEveryTime = newValue}
  }
  /// Returns true if `gpsLocatesEveryTime` has been explicitly set.
  var hasGpsLocatesEveryTime: Bool {return self._gpsLocatesEveryTime != nil}
  /// Clears the value of `gpsLocatesEveryTime`. Subsequent reads from it will return its default value.
  mutating func clearGpsLocatesEveryTime() {self._gpsLocatesEveryTime = nil}
  ...
  fileprivate var _gpsLocatesEveryTime: Bool? = nil
}

struct OM0SleepData: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// date of sleep data		
  var sleepDate: RtTime {
    get {return _sleepDate ?? RtTime()}
  ...
  /// sleep start time		
  var startTime: RtTime {
    get {return _startTime ?? RtTime()}
  ...
  /// minutes
  var lightSleep: UInt32 {
    get {return _lightSleep ?? 0}
    set {_lightSleep = newValue}
  }
  /// Returns true if `lightSleep` has been explicitly set.
  var hasLightSleep: Bool {return self._lightSleep != nil}
  /// Clears the value of `lightSleep`. Subsequent reads from it will return its default value.
  mutating func clearLightSleep() {self._lightSleep = nil}

  /// minutes	
  var weakSleep: UInt32 {
    get {return _weakSleep ?? 0}
    set {_weakSleep = newValue}
  }
  /// Returns true if `weakSleep` has been explicitly set.
  var hasWeakSleep: Bool {return self._weakSleep != nil}
  /// Clears the value of `weakSleep`. Subsequent reads from it will return its default value.
  mutating func clearWeakSleep() {self._weakSleep = nil}

  /// minutes	
  var eyemoveSleep: UInt32 {
    get {return _eyemoveSleep ?? 0}
    set {_eyemoveSleep = newValue}
  }
  /// Returns true if `eyemoveSleep` has been explicitly set.
  var hasEyemoveSleep: Bool {return self._eyemoveSleep != nil}
  /// Clears the value of `eyemoveSleep`. Subsequent reads from it will return its default value.
  mutating func clearEyemoveSleep() {self._eyemoveSleep = nil}
  ...
  /// minutes	
  var osahsRisk: UInt32 {
    get {return _osahsRisk ?? 0}
    set {_osahsRisk = newValue}
  }
  /// Returns true if `osahsRisk` has been explicitly set.
  var hasOsahsRisk: Bool {return self._osahsRisk != nil}
  /// Clears the value of `osahsRisk`. Subsequent reads from it will return its default value.
  mutating func clearOsahsRisk() {self._osahsRisk = nil}

  /// minutes	
  var spo2Score: UInt32 {
    get {return _spo2Score ?? 0}
    set {_spo2Score = newValue}
  }
  /// Returns true if `spo2Score` has been explicitly set.
  var hasSpo2Score: Bool {return self._spo2Score != nil}
  /// Clears the value of `spo2Score`. Subsequent reads from it will return its default value.
  mutating func clearSpo2Score() {self._spo2Score = nil}

  /// minutes	
  var avgRespirationRate: UInt32 {
    get {return _avgRespirationRate ?? 0}
    set {_avgRespirationRate = newValue}
  }
  /// Returns true if `avgRespirationRate` has been explicitly set.
  var hasAvgRespirationRate: Bool {return self._avgRespirationRate != nil}
  /// Clears the value of `avgRespirationRate`. Subsequent reads from it will return its default value.
  mutating func clearAvgRespirationRate() {self._avgRespirationRate = nil}

  /// minutes	
  var maxRespirationRate: UInt32 {
    get {return _maxRespirationRate ?? 0}
    set {_maxRespirationRate = newValue}
  }
  /// Returns true if `maxRespirationRate` has been explicitly set.
  var hasMaxRespirationRate: Bool {return self._maxRespirationRate != nil}
  /// Clears the value of `maxRespirationRate`. Subsequent reads from it will return its default value.
  mutating func clearMaxRespirationRate() {self._maxRespirationRate = nil}

  /// minutes	
  var minRespirationRate: UInt32 {
    get {return _minRespirationRate ?? 0}
    set {_minRespirationRate = newValue}
  }
  /// Returns true if `minRespirationRate` has been explicitly set.
  var hasMinRespirationRate: Bool {return self._minRespirationRate != nil}
  /// Clears the value of `minRespirationRate`. Subsequent reads from it will return its default value.
  mutating func clearMinRespirationRate() {self._minRespirationRate = nil}

  /// minutes	
  var sleepHr: UInt32 {
    get {return _sleepHr ?? 0}
    set {_sleepHr = newValue}
  }
  /// Returns true if `sleepHr` has been explicitly set.
  var hasSleepHr: Bool {return self._sleepHr != nil}
  /// Clears the value of `sleepHr`. Subsequent reads from it will return its default value.
  mutating func clearSleepHr() {self._sleepHr = nil}
  ...
  fileprivate var _sleepDate: RtTime? = nil
  fileprivate var _startTime: RtTime? = nil
  fileprivate var _endTime: RtTime? = nil
  fileprivate var _deepSleep: UInt32? = nil
  fileprivate var _lightSleep: UInt32? = nil
  fileprivate var _weakSleep: UInt32? = nil
  fileprivate var _eyemoveSleep: UInt32? = nil
  fileprivate var _score: UInt32? = nil
  fileprivate var _osahsRisk: UInt32? = nil
  fileprivate var _spo2Score: UInt32? = nil
  fileprivate var _avgRespirationRate: UInt32? = nil
  fileprivate var _maxRespirationRate: UInt32? = nil
  fileprivate var _minRespirationRate: UInt32? = nil
  fileprivate var _sleepHr: UInt32? = nil
  fileprivate var _completed: UInt32? = nil
}

struct OM0Command: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct OM0Report: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension OM0TrackConf: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "GPS_locates_every_time"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularBoolField(value: &self._gpsLocatesEveryTime) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._gpsLocatesEveryTime {
  ...
  static func ==(lhs: OM0TrackConf, rhs: OM0TrackConf) -> Bool {
    ...
    if lhs._gpsLocatesEveryTime != rhs._gpsLocatesEveryTime {return false}
...
extension OM0SleepData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "deep_sleep"),
    5: .standard(proto: "light_sleep"),
    6: .standard(proto: "weak_sleep"),
    7: .standard(proto: "eyemove_sleep"),
    8: .same(proto: "score"),
    9: .standard(proto: "osahs_risk"),
    10: .standard(proto: "spo2_score"),
    11: .standard(proto: "avg_respiration_rate"),
    12: .standard(proto: "max_respiration_rate"),
    13: .standard(proto: "min_respiration_rate"),
    14: .standard(proto: "sleep_hr"),
    15: .same(proto: "completed"),
  ]

  public var isInitialized: Bool {
    if self._sleepDate == nil {return false}
    if self._startTime == nil {return false}
    if self._endTime == nil {return false}
    if self._deepSleep == nil {return false}
    if self._lightSleep == nil {return false}
    if self._weakSleep == nil {return false}
    if self._eyemoveSleep == nil {return false}
    if self._score == nil {return false}
    if self._osahsRisk == nil {return false}
    if self._spo2Score == nil {return false}
    if self._avgRespirationRate == nil {return false}
    if self._maxRespirationRate == nil {return false}
    if self._minRespirationRate == nil {return false}
    if self._sleepHr == nil {return false}
    if self._completed == nil {return false}
    if let v = self._sleepDate, !v.isInitialized {return false}
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularFixed32Field(value: &self._deepSleep) }()
      case 5: try { try decoder.decodeSingularFixed32Field(value: &self._lightSleep) }()
      case 6: try { try decoder.decodeSingularFixed32Field(value: &self._weakSleep) }()
      case 7: try { try decoder.decodeSingularFixed32Field(value: &self._eyemoveSleep) }()
      case 8: try { try decoder.decodeSingularFixed32Field(value: &self._score) }()
      case 9: try { try decoder.decodeSingularFixed32Field(value: &self._osahsRisk) }()
      case 10: try { try decoder.decodeSingularFixed32Field(value: &self._spo2Score) }()
      case 11: try { try decoder.decodeSingularFixed32Field(value: &self._avgRespirationRate) }()
      case 12: try { try decoder.decodeSingularFixed32Field(value: &self._maxRespirationRate) }()
      case 13: try { try decoder.decodeSingularFixed32Field(value: &self._minRespirationRate) }()
      case 14: try { try decoder.decodeSingularFixed32Field(value: &self._sleepHr) }()
      case 15: try { try decoder.decodeSingularFixed32Field(value: &self._completed) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: OM0SleepData, rhs: OM0SleepData) -> Bool {
    ...
    if lhs._lightSleep != rhs._lightSleep {return false}
    if lhs._weakSleep != rhs._weakSleep {return false}
    if lhs._eyemoveSleep != rhs._eyemoveSleep {return false}
    if lhs._score != rhs._score {return false}
    if lhs._osahsRisk != rhs._osahsRisk {return false}
    if lhs._spo2Score != rhs._spo2Score {return false}
    if lhs._avgRespirationRate != rhs._avgRespirationRate {return false}
    if lhs._maxRespirationRate != rhs._maxRespirationRate {return false}
    if lhs._minRespirationRate != rhs._minRespirationRate {return false}
    if lhs._sleepHr != rhs._sleepHr {return false}
...
extension OM0Command: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularMessageField(value: &_storage._trackConf) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
      // https://github.com/apple/swift-protobuf/issues/1182
      try { if let v = _storage._trackConf {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
      } }()
