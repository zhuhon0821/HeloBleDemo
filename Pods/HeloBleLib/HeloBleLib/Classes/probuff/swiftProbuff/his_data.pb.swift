...
enum HisOperation: SwiftProtobuf.Enum, Swift.CaseIterable {
...
enum HisDataType: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case healthData // = 0
  case gnssData // = 1
  case ecgData // = 2
  ...
  case longEcgData // = 13
  case thirdpartyData // = 14
  case thirdpartyDataV2 // = 15
  case gyroscopeData // = 16
  case accelerometerData // = 17
  case yylpfeData // = 18
  case multiLeadsEcgData // = 19
  case bpOriginalData // = 20
  ...
  init?(rawValue: Int) {
    ...
    case 14: self = .thirdpartyData
    case 15: self = .thirdpartyDataV2
    case 16: self = .gyroscopeData
    case 17: self = .accelerometerData
    case 18: self = .yylpfeData
    case 19: self = .multiLeadsEcgData
    case 20: self = .bpOriginalData
    default: return nil
    }
  }
  ...
  var rawValue: Int {
    ...
    case .thirdpartyData: return 14
    case .thirdpartyDataV2: return 15
    case .gyroscopeData: return 16
    case .accelerometerData: return 17
    case .yylpfeData: return 18
    case .multiLeadsEcgData: return 19
    case .bpOriginalData: return 20
    }
  }

}

enum HisDataStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case statusOk // = 0
...
struct HisData: Sendable {
  ...
  var thirdPartyData: HisDataThirdParty {
    get {
      if case .thirdPartyData(let v)? = data {return v}
      return HisDataThirdParty()
    }
    set {data = .thirdPartyData(newValue)}
  }

  var thirdPartyDataV2: HisDataThirdPartyV2 {
    get {
      if case .thirdPartyDataV2(let v)? = data {return v}
      return HisDataThirdPartyV2()
    }
    set {data = .thirdPartyDataV2(newValue)}
  }

  var accelerometerData: HisACCelerometer {
    get {
      if case .accelerometerData(let v)? = data {return v}
      return HisACCelerometer()
    }
    set {data = .accelerometerData(newValue)}
  }

  var gyroscopeData: HisGyroscope {
    get {
      if case .gyroscopeData(let v)? = data {return v}
      return HisGyroscope()
    }
    set {data = .gyroscopeData(newValue)}
  }

  var yylpfe: HisDataYYLPFE {
    get {
      if case .yylpfe(let v)? = data {return v}
      return HisDataYYLPFE()
    }
    set {data = .yylpfe(newValue)}
  }

  var multiLeadsEcg: HisDataMultiLeadsECG {
    get {
      if case .multiLeadsEcg(let v)? = data {return v}
      return HisDataMultiLeadsECG()
    }
    set {data = .multiLeadsEcg(newValue)}
  }

  var bpOriginalData: HisData_BP_Original {
    get {
      if case .bpOriginalData(let v)? = data {return v}
      return HisData_BP_Original()
    }
    set {data = .bpOriginalData(newValue)}
  }
  ...
  enum OneOf_Data: Equatable, Sendable {
    ...
    case thirdPartyData(HisDataThirdParty)
    case thirdPartyDataV2(HisDataThirdPartyV2)
    case accelerometerData(HisACCelerometer)
    case gyroscopeData(HisGyroscope)
    case yylpfe(HisDataYYLPFE)
    case multiLeadsEcg(HisDataMultiLeadsECG)
    case bpOriginalData(HisData_BP_Original)
    ...
    fileprivate var isInitialized: Bool {
      ...
      case .thirdPartyData: return {
        guard case .thirdPartyData(let v) = self else { preconditionFailure() }
        return v.isInitialized
      }()
      case .thirdPartyDataV2: return {
        guard case .thirdPartyDataV2(let v) = self else { preconditionFailure() }
        return v.isInitialized
      }()
      case .accelerometerData: return {
        guard case .accelerometerData(let v) = self else { preconditionFailure() }
        return v.isInitialized
      }()
      case .gyroscopeData: return {
        guard case .gyroscopeData(let v) = self else { preconditionFailure() }
        return v.isInitialized
      }()
      case .yylpfe: return {
        guard case .yylpfe(let v) = self else { preconditionFailure() }
        return v.isInitialized
      }()
      case .multiLeadsEcg: return {
        guard case .multiLeadsEcg(let v) = self else { preconditionFailure() }
        return v.isInitialized
      }()
      case .bpOriginalData: return {
        guard case .bpOriginalData(let v) = self else { preconditionFailure() }
        return v.isInitialized
      }()
      default: return true
      }
...
struct HisNotification: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension HisDataType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    14: .same(proto: "THIRDPARTY_DATA"),
    15: .same(proto: "THIRDPARTY_DATA_V2"),
    16: .same(proto: "GYROSCOPE_DATA"),
    17: .same(proto: "ACCELEROMETER_DATA"),
    18: .same(proto: "YYLPFE_DATA"),
    19: .same(proto: "MULTI_LEADS_ECG_DATA"),
    20: .same(proto: "BP_ORIGINAL_DATA"),
  ]
}
...
extension HisData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    16: .standard(proto: "ThirdParty_data"),
    17: .standard(proto: "ThirdParty_data_V2"),
    18: .standard(proto: "ACCelerometer_data"),
    19: .standard(proto: "Gyroscope_data"),
    20: .same(proto: "YYLPFE"),
    21: .same(proto: "MultiLeadsECG"),
    22: .standard(proto: "BP_Original_data"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 16: try {
        var v: HisDataThirdParty?
        var hadOneofValue = false
        if let current = self.data {
          hadOneofValue = true
          if case .thirdPartyData(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.data = .thirdPartyData(v)
        }
      }()
      case 17: try {
        var v: HisDataThirdPartyV2?
        var hadOneofValue = false
        if let current = self.data {
          hadOneofValue = true
          if case .thirdPartyDataV2(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.data = .thirdPartyDataV2(v)
        }
      }()
      case 18: try {
        var v: HisACCelerometer?
        var hadOneofValue = false
        if let current = self.data {
          hadOneofValue = true
          if case .accelerometerData(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.data = .accelerometerData(v)
        }
      }()
      case 19: try {
        var v: HisGyroscope?
        ...
        if let current = self.data {
          hadOneofValue = true
          if case .gyroscopeData(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.data = .gyroscopeData(v)
        }
      }()
      case 20: try {
        var v: HisDataYYLPFE?
        ...
        if let current = self.data {
          hadOneofValue = true
          if case .yylpfe(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
      ...
      case 21: try {
        var v: HisDataMultiLeadsECG?
        var hadOneofValue = false
        if let current = self.data {
          hadOneofValue = true
          if case .multiLeadsEcg(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.data = .multiLeadsEcg(v)
        }
      }()
      case 22: try {
        var v: HisData_BP_Original?
        var hadOneofValue = false
        if let current = self.data {
          hadOneofValue = true
          if case .bpOriginalData(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.data = .bpOriginalData(v)
        }
      }()
      default: break
      }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .thirdPartyData?: try {
      guard case .thirdPartyData(let v)? = self.data else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 16)
    }()
    case .thirdPartyDataV2?: try {
      guard case .thirdPartyDataV2(let v)? = self.data else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 17)
    }()
    case .accelerometerData?: try {
      guard case .accelerometerData(let v)? = self.data else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 18)
    }()
    case .gyroscopeData?: try {
      guard case .gyroscopeData(let v)? = self.data else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 19)
    }()
    case .yylpfe?: try {
      guard case .yylpfe(let v)? = self.data else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 20)
    }()
    case .multiLeadsEcg?: try {
      guard case .multiLeadsEcg(let v)? = self.data else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 21)
    }()
    case .bpOriginalData?: try {
      guard case .bpOriginalData(let v)? = self.data else { preconditionFailure() }
