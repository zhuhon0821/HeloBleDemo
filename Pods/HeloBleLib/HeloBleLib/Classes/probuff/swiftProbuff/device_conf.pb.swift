...
enum DeviceLanuage: SwiftProtobuf.Enum, Swift.CaseIterable {
...
struct HealthDataConfig: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var bloodSugarConfig: Bool {
    get {return _bloodSugarConfig ?? false}
    set {_bloodSugarConfig = newValue}
  }
  /// Returns true if `bloodSugarConfig` has been explicitly set.
  var hasBloodSugarConfig: Bool {return self._bloodSugarConfig != nil}
  /// Clears the value of `bloodSugarConfig`. Subsequent reads from it will return its default value.
  mutating func clearBloodSugarConfig() {self._bloodSugarConfig = nil}

  var bloodPotassiumConfig: Bool {
    get {return _bloodPotassiumConfig ?? false}
    set {_bloodPotassiumConfig = newValue}
  }
  /// Returns true if `bloodPotassiumConfig` has been explicitly set.
  var hasBloodPotassiumConfig: Bool {return self._bloodPotassiumConfig != nil}
  /// Clears the value of `bloodPotassiumConfig`. Subsequent reads from it will return its default value.
  mutating func clearBloodPotassiumConfig() {self._bloodPotassiumConfig = nil}

  var pressureConfig: Bool {
    get {return _pressureConfig ?? false}
    set {_pressureConfig = newValue}
  }
  /// Returns true if `pressureConfig` has been explicitly set.
  var hasPressureConfig: Bool {return self._pressureConfig != nil}
  /// Clears the value of `pressureConfig`. Subsequent reads from it will return its default value.
  mutating func clearPressureConfig() {self._pressureConfig = nil}

  var apgConfig: Bool {
    get {return _apgConfig ?? false}
    set {_apgConfig = newValue}
  }
  /// Returns true if `apgConfig` has been explicitly set.
  var hasApgConfig: Bool {return self._apgConfig != nil}
  /// Clears the value of `apgConfig`. Subsequent reads from it will return its default value.
  mutating func clearApgConfig() {self._apgConfig = nil}
  ...
  fileprivate var _bloodSugarConfig: Bool? = nil
  fileprivate var _bloodPotassiumConfig: Bool? = nil
  fileprivate var _pressureConfig: Bool? = nil
  fileprivate var _apgConfig: Bool? = nil
}

struct DeviceConfNotification: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var audioSwitch: Bool {
    get {return _storage._audioSwitch ?? false}
    set {_uniqueStorage()._audioSwitch = newValue}
  }
  /// Returns true if `audioSwitch` has been explicitly set.
  var hasAudioSwitch: Bool {return _storage._audioSwitch != nil}
  /// Clears the value of `audioSwitch`. Subsequent reads from it will return its default value.
  mutating func clearAudioSwitch() {_uniqueStorage()._audioSwitch = nil}

  ///[default = 1400];
  var fallThreshold: UInt32 {
    get {return _storage._fallThreshold ?? 0}
    set {_uniqueStorage()._fallThreshold = newValue}
  }
  /// Returns true if `fallThreshold` has been explicitly set.
  var hasFallThreshold: Bool {return _storage._fallThreshold != nil}
  /// Clears the value of `fallThreshold`. Subsequent reads from it will return its default value.
  mutating func clearFallThreshold() {_uniqueStorage()._fallThreshold = nil}

  var allMeasure: Bool {
    get {return _storage._allMeasure ?? false}
    set {_uniqueStorage()._allMeasure = newValue}
  }
  /// Returns true if `allMeasure` has been explicitly set.
  var hasAllMeasure: Bool {return _storage._allMeasure != nil}
  /// Clears the value of `allMeasure`. Subsequent reads from it will return its default value.
  mutating func clearAllMeasure() {_uniqueStorage()._allMeasure = nil}

  var hrInterval: UInt32 {
    get {return _storage._hrInterval ?? 0}
    set {_uniqueStorage()._hrInterval = newValue}
  }
  /// Returns true if `hrInterval` has been explicitly set.
  var hasHrInterval: Bool {return _storage._hrInterval != nil}
  /// Clears the value of `hrInterval`. Subsequent reads from it will return its default value.
  mutating func clearHrInterval() {_uniqueStorage()._hrInterval = nil}

  var hrvInterval: UInt32 {
    get {return _storage._hrvInterval ?? 0}
    set {_uniqueStorage()._hrvInterval = newValue}
  }
  /// Returns true if `hrvInterval` has been explicitly set.
  var hasHrvInterval: Bool {return _storage._hrvInterval != nil}
  /// Clears the value of `hrvInterval`. Subsequent reads from it will return its default value.
  mutating func clearHrvInterval() {_uniqueStorage()._hrvInterval = nil}

  var sportConfig: Bool {
    get {return _storage._sportConfig ?? false}
    set {_uniqueStorage()._sportConfig = newValue}
  }
  /// Returns true if `sportConfig` has been explicitly set.
  var hasSportConfig: Bool {return _storage._sportConfig != nil}
  /// Clears the value of `sportConfig`. Subsequent reads from it will return its default value.
  mutating func clearSportConfig() {_uniqueStorage()._sportConfig = nil}
...
struct DeviceConfSubscriber: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var supportSoTheMeasure: Bool {
    get {return _storage._supportSoTheMeasure ?? false}
    set {_uniqueStorage()._supportSoTheMeasure = newValue}
  }
  /// Returns true if `supportSoTheMeasure` has been explicitly set.
  var hasSupportSoTheMeasure: Bool {return _storage._supportSoTheMeasure != nil}
  /// Clears the value of `supportSoTheMeasure`. Subsequent reads from it will return its default value.
  mutating func clearSupportSoTheMeasure() {_uniqueStorage()._supportSoTheMeasure = nil}
...
extension HealthDataConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    11: .standard(proto: "Blood_sugar_config"),
    12: .standard(proto: "Blood_Potassium_config"),
    13: .standard(proto: "Pressure_config"),
    14: .standard(proto: "apg_config"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 11: try { try decoder.decodeSingularBoolField(value: &self._bloodSugarConfig) }()
      case 12: try { try decoder.decodeSingularBoolField(value: &self._bloodPotassiumConfig) }()
      case 13: try { try decoder.decodeSingularBoolField(value: &self._pressureConfig) }()
      case 14: try { try decoder.decodeSingularBoolField(value: &self._apgConfig) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._bloodSugarConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 11)
    } }()
    try { if let v = self._bloodPotassiumConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 12)
    } }()
    try { if let v = self._pressureConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 13)
    } }()
    try { if let v = self._apgConfig {
  ...
  static func ==(lhs: HealthDataConfig, rhs: HealthDataConfig) -> Bool {
    ...
    if lhs._bloodSugarConfig != rhs._bloodSugarConfig {return false}
    if lhs._bloodPotassiumConfig != rhs._bloodPotassiumConfig {return false}
    if lhs._pressureConfig != rhs._pressureConfig {return false}
    if lhs._apgConfig != rhs._apgConfig {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension DeviceConfNotification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    23: .standard(proto: "audio_switch"),
    24: .standard(proto: "fall_threshold"),
    25: .standard(proto: "All_measure"),
    26: .standard(proto: "HR_Interval"),
    27: .standard(proto: "HRV_Interval"),
    28: .standard(proto: "sport_config"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _audioSwitch: Bool? = nil
    var _fallThreshold: UInt32? = nil
    var _allMeasure: Bool? = nil
    var _hrInterval: UInt32? = nil
    var _hrvInterval: UInt32? = nil
    var _sportConfig: Bool? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _audioSwitch = source._audioSwitch
      _fallThreshold = source._fallThreshold
      _allMeasure = source._allMeasure
      _hrInterval = source._hrInterval
      _hrvInterval = source._hrvInterval
      _sportConfig = source._sportConfig
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 23: try { try decoder.decodeSingularBoolField(value: &_storage._audioSwitch) }()
        case 24: try { try decoder.decodeSingularFixed32Field(value: &_storage._fallThreshold) }()
        case 25: try { try decoder.decodeSingularBoolField(value: &_storage._allMeasure) }()
        case 26: try { try decoder.decodeSingularFixed32Field(value: &_storage._hrInterval) }()
        case 27: try { try decoder.decodeSingularFixed32Field(value: &_storage._hrvInterval) }()
        case 28: try { try decoder.decodeSingularBoolField(value: &_storage._sportConfig) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._audioSwitch {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 23)
      } }()
      try { if let v = _storage._fallThreshold {
        try visitor.visitSingularFixed32Field(value: v, fieldNumber: 24)
      } }()
      try { if let v = _storage._allMeasure {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 25)
      } }()
      try { if let v = _storage._hrInterval {
        try visitor.visitSingularFixed32Field(value: v, fieldNumber: 26)
      } }()
      try { if let v = _storage._hrvInterval {
        try visitor.visitSingularFixed32Field(value: v, fieldNumber: 27)
      } }()
      try { if let v = _storage._sportConfig {
  ...
  static func ==(lhs: DeviceConfNotification, rhs: DeviceConfNotification) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._audioSwitch != rhs_storage._audioSwitch {return false}
        if _storage._fallThreshold != rhs_storage._fallThreshold {return false}
        if _storage._allMeasure != rhs_storage._allMeasure {return false}
        if _storage._hrInterval != rhs_storage._hrInterval {return false}
        if _storage._hrvInterval != rhs_storage._hrvInterval {return false}
        if _storage._sportConfig != rhs_storage._sportConfig {return false}
        return true
      }
...
extension DeviceConfSubscriber: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    23: .standard(proto: "support_So_the_measure"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _supportSoTheMeasure: Bool? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _supportSoTheMeasure = source._supportSoTheMeasure
    }
  }
  ...
  public var isInitialized: Bool {
    return withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._supportSoTheMeasure == nil {return false}
      return true
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 23: try { try decoder.decodeSingularBoolField(value: &_storage._supportSoTheMeasure) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._supportSoTheMeasure {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 23)
      } }()
    }
    try unknownFields.traverse(visitor: &visitor)
  ...
  static func ==(lhs: DeviceConfSubscriber, rhs: DeviceConfSubscriber) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._supportSoTheMeasure != rhs_storage._supportSoTheMeasure {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
