...
enum RtMode: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  var rawValue: Int {
    ...
    case .breathMeasure: return 8
    }
  }

}

enum RtKeyEvent: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case rtKeyCamera // = 0
...
enum RtSync: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case stopAll // = 0
  case onlyOnce // = 1
...
enum SensorType: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case none // = 0
  case ecg // = 1
  case ppg // = 2
...
enum SensorOperation: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
...
enum SportOperation: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  init?(rawValue: Int) {
    switch rawValue {
    case 0: self = .sportStart
    case 1: self = .sportPause
    case 2: self = .sportStop
    default: return nil
    }
  }
  ...
  var rawValue: Int {
    switch self {
    case .sportStart: return 0
    case .sportPause: return 1
    case .sportStop: return 2
    }
  }

}

struct RtTime: Sendable {
...
struct RtHealthResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Rtsport: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var operation: SportOperation {
    get {return _operation ?? .sportStart}
    set {_operation = newValue}
  }
  /// Returns true if `operation` has been explicitly set.
  var hasOperation: Bool {return self._operation != nil}
  ...
  var sportType: UInt32 {
    get {return _sportType ?? 0}
    set {_sportType = newValue}
  }
  /// Returns true if `sportType` has been explicitly set.
  var hasSportType: Bool {return self._sportType != nil}
  /// Clears the value of `sportType`. Subsequent reads from it will return its default value.
  mutating func clearSportType() {self._sportType = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _operation: SportOperation? = nil
  fileprivate var _sportType: UInt32? = nil
}

struct RtSubscriber: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  fileprivate var _sport: Rtsport? = nil
}

struct RtData: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct RtDtda_Summary: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct RtSportData: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var sdSportType: UInt32 {
    get {return _sdSportType ?? 0}
    set {_sdSportType = newValue}
  }
  /// Returns true if `sdSportType` has been explicitly set.
  var hasSdSportType: Bool {return self._sdSportType != nil}
  /// Clears the value of `sdSportType`. Subsequent reads from it will return its default value.
  mutating func clearSdSportType() {self._sdSportType = nil}

  var hrTotal: UInt32 {
    get {return _hrTotal ?? 0}
    set {_hrTotal = newValue}
  }
  /// Returns true if `hrTotal` has been explicitly set.
  var hasHrTotal: Bool {return self._hrTotal != nil}
  /// Clears the value of `hrTotal`. Subsequent reads from it will return its default value.
  mutating func clearHrTotal() {self._hrTotal = nil}

  var hrCount: UInt32 {
    get {return _hrCount ?? 0}
    set {_hrCount = newValue}
  }
  /// Returns true if `hrCount` has been explicitly set.
  var hasHrCount: Bool {return self._hrCount != nil}
  /// Clears the value of `hrCount`. Subsequent reads from it will return its default value.
  mutating func clearHrCount() {self._hrCount = nil}

  var realtimePace: UInt32 {
    get {return _realtimePace ?? 0}
    set {_realtimePace = newValue}
  }
  /// Returns true if `realtimePace` has been explicitly set.
  var hasRealtimePace: Bool {return self._realtimePace != nil}
  /// Clears the value of `realtimePace`. Subsequent reads from it will return its default value.
  mutating func clearRealtimePace() {self._realtimePace = nil}

  var realtimeSpm: UInt32 {
    get {return _realtimeSpm ?? 0}
    set {_realtimeSpm = newValue}
  }
  /// Returns true if `realtimeSpm` has been explicitly set.
  var hasRealtimeSpm: Bool {return self._realtimeSpm != nil}
  /// Clears the value of `realtimeSpm`. Subsequent reads from it will return its default value.
  mutating func clearRealtimeSpm() {self._realtimeSpm = nil}

  var realtimeHr: UInt32 {
    get {return _realtimeHr ?? 0}
    set {_realtimeHr = newValue}
  }
  /// Returns true if `realtimeHr` has been explicitly set.
  var hasRealtimeHr: Bool {return self._realtimeHr != nil}
  /// Clears the value of `realtimeHr`. Subsequent reads from it will return its default value.
  mutating func clearRealtimeHr() {self._realtimeHr = nil}

  var swimCircle: UInt32 {
    get {return _swimCircle ?? 0}
    set {_swimCircle = newValue}
  }
  /// Returns true if `swimCircle` has been explicitly set.
  var hasSwimCircle: Bool {return self._swimCircle != nil}
  /// Clears the value of `swimCircle`. Subsequent reads from it will return its default value.
  mutating func clearSwimCircle() {self._swimCircle = nil}

  var swimStroke: UInt32 {
    get {return _swimStroke ?? 0}
    set {_swimStroke = newValue}
  }
  /// Returns true if `swimStroke` has been explicitly set.
  var hasSwimStroke: Bool {return self._swimStroke != nil}
  /// Clears the value of `swimStroke`. Subsequent reads from it will return its default value.
  mutating func clearSwimStroke() {self._swimStroke = nil}

  var dataTotal: RtDtda_Summary {
    get {return _dataTotal ?? RtDtda_Summary()}
    set {_dataTotal = newValue}
  }
  /// Returns true if `dataTotal` has been explicitly set.
  var hasDataTotal: Bool {return self._dataTotal != nil}
  /// Clears the value of `dataTotal`. Subsequent reads from it will return its default value.
  mutating func clearDataTotal() {self._dataTotal = nil}

  var dataSport: RtDtda_Summary {
    get {return _dataSport ?? RtDtda_Summary()}
    set {_dataSport = newValue}
  }
  /// Returns true if `dataSport` has been explicitly set.
  var hasDataSport: Bool {return self._dataSport != nil}
  /// Clears the value of `dataSport`. Subsequent reads from it will return its default value.
  mutating func clearDataSport() {self._dataSport = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _sdSportType: UInt32? = nil
  fileprivate var _hrTotal: UInt32? = nil
  fileprivate var _hrCount: UInt32? = nil
  fileprivate var _realtimePace: UInt32? = nil
  fileprivate var _realtimeSpm: UInt32? = nil
  fileprivate var _realtimeHr: UInt32? = nil
  fileprivate var _swimCircle: UInt32? = nil
  fileprivate var _swimStroke: UInt32? = nil
  fileprivate var _dataTotal: RtDtda_Summary? = nil
  fileprivate var _dataSport: RtDtda_Summary? = nil
}

struct RtNotification: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var rtSportData: RtSportData {
    get {
      if case .rtSportData(let v)? = data {return v}
      return RtSportData()
    }
    set {data = .rtSportData(newValue)}
  }
  ...
  enum OneOf_Data: Equatable, Sendable {
    ...
    fileprivate var isInitialized: Bool {
      ...
      case .rtSportData: return {
        guard case .rtSportData(let v) = self else { preconditionFailure() }
        return v.isInitialized
      }()
      default: return true
      }
...
extension RtMode: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    8: .same(proto: "RT_MODE_BREATH_MEASURE"),
  ]
}
...
extension SportOperation: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "SPORT_START"),
    1: .same(proto: "SPORT_PAUSE"),
    2: .same(proto: "SPORT_STOP"),
  ]
}
...
extension Rtsport: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "Rtsport"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "operation"),
  ...
  public var isInitialized: Bool {
    if self._operation == nil {return false}
    if self._sportType == nil {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self._operation) }()
      case 2: try { try decoder.decodeSingularFixed32Field(value: &self._sportType) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._sportType {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 2)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Rtsport, rhs: Rtsport) -> Bool {
    if lhs._operation != rhs._operation {return false}
    if lhs._sportType != rhs._sportType {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension RtSubscriber: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public var isInitialized: Bool {
    ...
    if let v = self._sport, !v.isInitialized {return false}
    return true
  }
...
extension RtDtda_Summary: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "RtDtda_Summary"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "time"),
    2: .same(proto: "steps"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularFixed32Field(value: &self._time) }()
      case 2: try { try decoder.decodeSingularFixed32Field(value: &self._steps) }()
      case 3: try { try decoder.decodeSingularFixed32Field(value: &self._distance) }()
  ...
  static func ==(lhs: RtDtda_Summary, rhs: RtDtda_Summary) -> Bool {
    if lhs._time != rhs._time {return false}
    if lhs._steps != rhs._steps {return false}
    if lhs._distance != rhs._distance {return false}
    if lhs._calorie != rhs._calorie {return false}
...
extension RtSportData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "RtSportData"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "sd_sportType"),
    2: .standard(proto: "hr_total"),
    3: .standard(proto: "hr_count"),
    4: .standard(proto: "realtime_pace"),
    5: .standard(proto: "realtime_spm"),
    6: .standard(proto: "realtime_hr"),
    7: .standard(proto: "swim_circle"),
    8: .standard(proto: "swim_stroke"),
    9: .standard(proto: "data_total"),
    10: .standard(proto: "data_sport"),
  ]

  public var isInitialized: Bool {
    if self._sdSportType == nil {return false}
    if self._hrTotal == nil {return false}
    if self._hrCount == nil {return false}
    if self._realtimePace == nil {return false}
    if self._realtimeSpm == nil {return false}
    if self._realtimeHr == nil {return false}
    if self._swimCircle == nil {return false}
    if self._swimStroke == nil {return false}
    if self._dataTotal == nil {return false}
    if self._dataSport == nil {return false}
    if let v = self._dataTotal, !v.isInitialized {return false}
    if let v = self._dataSport, !v.isInitialized {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularFixed32Field(value: &self._sdSportType) }()
      case 2: try { try decoder.decodeSingularFixed32Field(value: &self._hrTotal) }()
      case 3: try { try decoder.decodeSingularFixed32Field(value: &self._hrCount) }()
      case 4: try { try decoder.decodeSingularFixed32Field(value: &self._realtimePace) }()
      case 5: try { try decoder.decodeSingularFixed32Field(value: &self._realtimeSpm) }()
      case 6: try { try decoder.decodeSingularFixed32Field(value: &self._realtimeHr) }()
      case 7: try { try decoder.decodeSingularFixed32Field(value: &self._swimCircle) }()
      case 8: try { try decoder.decodeSingularFixed32Field(value: &self._swimStroke) }()
      case 9: try { try decoder.decodeSingularMessageField(value: &self._dataTotal) }()
      case 10: try { try decoder.decodeSingularMessageField(value: &self._dataSport) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._sdSportType {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 1)
    } }()
    try { if let v = self._hrTotal {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 2)
    } }()
    try { if let v = self._hrCount {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 3)
    } }()
    try { if let v = self._realtimePace {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 4)
    } }()
    try { if let v = self._realtimeSpm {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 5)
    } }()
    try { if let v = self._realtimeHr {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 6)
    } }()
    try { if let v = self._swimCircle {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 7)
    } }()
    try { if let v = self._swimStroke {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 8)
    } }()
    try { if let v = self._dataTotal {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 9)
    } }()
    try { if let v = self._dataSport {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: RtSportData, rhs: RtSportData) -> Bool {
    if lhs._sdSportType != rhs._sdSportType {return false}
    if lhs._hrTotal != rhs._hrTotal {return false}
    if lhs._hrCount != rhs._hrCount {return false}
    if lhs._realtimePace != rhs._realtimePace {return false}
    if lhs._realtimeSpm != rhs._realtimeSpm {return false}
    if lhs._realtimeHr != rhs._realtimeHr {return false}
    if lhs._swimCircle != rhs._swimCircle {return false}
    if lhs._swimStroke != rhs._swimStroke {return false}
    if lhs._dataTotal != rhs._dataTotal {return false}
    if lhs._dataSport != rhs._dataSport {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension RtNotification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "rt_sport_data"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try {
        ...
        if let current = self.data {
          hadOneofValue = true
          if case .rtSportData(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.data = .rtSportData(v)
        }
      }()
      default: break
      }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .rtSportData?: try {
      guard case .rtSportData(let v)? = self.data else { preconditionFailure() }
