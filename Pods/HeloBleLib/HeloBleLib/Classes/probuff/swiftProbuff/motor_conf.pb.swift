...
enum VibrateType: SwiftProtobuf.Enum, Swift.CaseIterable {
...
enum MotorOperation: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case config // = 0
  case vibrate // = 1
...
struct MotorConfSubscriber: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct MotorConfNotification: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
