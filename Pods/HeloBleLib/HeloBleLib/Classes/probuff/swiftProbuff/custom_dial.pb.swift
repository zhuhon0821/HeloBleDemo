...
enum DialIndex: SwiftProtobuf.Enum, Swift.CaseIterable {
...
enum ElementType: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case elementBat // = 1
...
enum TimeRealStyle: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
...
enum StateType: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case stateBle // = 0
  case stateMsg // = 1
...
struct InfoProgressBarCircle: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct InfoProgressBarRec: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct InfoProgressBar: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct InfoTimePointer: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var secIcon: InfoIcon {
    get {return _secIcon ?? InfoIcon()}
    set {_secIcon = newValue}
  }
  /// Returns true if `secIcon` has been explicitly set.
  var hasSecIcon: Bool {return self._secIcon != nil}
  /// Clears the value of `secIcon`. Subsequent reads from it will return its default value.
  mutating func clearSecIcon() {self._secIcon = nil}
  ...
  fileprivate var _hourIcon: InfoIcon? = nil
  fileprivate var _minIcon: InfoIcon? = nil
  fileprivate var _secIcon: InfoIcon? = nil
}

struct InfoTime: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var timePointer: InfoTimePointer {
    get {
      if case .timePointer(let v)? = data {return v}
      return InfoTimePointer()
    }
    set {data = .timePointer(newValue)}
  }
  ...
  enum OneOf_Data: Equatable, Sendable {
    ...
    case timePointer(InfoTimePointer)
    ...
    fileprivate var isInitialized: Bool {
      ...
      case .timePointer: return {
        guard case .timePointer(let v) = self else { preconditionFailure() }
        return v.isInitialized
      }()
      }
    }
...
struct CustomDialIndexGroup: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct CustomDialConf: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct CustomDialNotification: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct CustomDialRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct CustomDialSubscriber: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct CustomDialConfim: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension InfoTimePointer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "InfoTimePointer"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "hour_icon"),
    2: .standard(proto: "min_icon"),
    3: .standard(proto: "sec_icon"),
  ]
  ...
  public var isInitialized: Bool {
    ...
    if let v = self._hourIcon, !v.isInitialized {return false}
    if let v = self._minIcon, !v.isInitialized {return false}
    if let v = self._secIcon, !v.isInitialized {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._hourIcon) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._minIcon) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._secIcon) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._secIcon {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: InfoTimePointer, rhs: InfoTimePointer) -> Bool {
    if lhs._hourIcon != rhs._hourIcon {return false}
    if lhs._minIcon != rhs._minIcon {return false}
    if lhs._secIcon != rhs._secIcon {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension InfoTime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try {
        var v: InfoTimePointer?
        var hadOneofValue = false
        if let current = self.data {
          hadOneofValue = true
          if case .timePointer(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.data = .timePointer(v)
        }
      }()
      default: break
      }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .timePointer?: try {
      guard case .timePointer(let v)? = self.data else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case nil: break
    }
