...
struct PeerInfoSubsriber: @unchecked Sendable {
...
struct spo2AlarmConfv2: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct BpAlarmCustomConf: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TemperatureAlarmConfv2: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct BloodsugarAlarmConf: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var bloodsugarHighr: Float {
    get {return _bloodsugarHighr ?? 0}
    set {_bloodsugarHighr = newValue}
  }
  /// Returns true if `bloodsugarHighr` has been explicitly set.
  var hasBloodsugarHighr: Bool {return self._bloodsugarHighr != nil}
  /// Clears the value of `bloodsugarHighr`. Subsequent reads from it will return its default value.
  mutating func clearBloodsugarHighr() {self._bloodsugarHighr = nil}

  var bloodsugarBelow: Float {
    get {return _bloodsugarBelow ?? 0}
    set {_bloodsugarBelow = newValue}
  }
  /// Returns true if `bloodsugarBelow` has been explicitly set.
  var hasBloodsugarBelow: Bool {return self._bloodsugarBelow != nil}
  /// Clears the value of `bloodsugarBelow`. Subsequent reads from it will return its default value.
  mutating func clearBloodsugarBelow() {self._bloodsugarBelow = nil}
  ...
  fileprivate var _enable: Bool? = nil
  fileprivate var _bloodsugarHighr: Float? = nil
  fileprivate var _bloodsugarBelow: Float? = nil
}

struct BloodpotassiumAlarmConf: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var bloodpotassiumHigh: Float {
    get {return _bloodpotassiumHigh ?? 0}
    set {_bloodpotassiumHigh = newValue}
  }
  /// Returns true if `bloodpotassiumHigh` has been explicitly set.
  var hasBloodpotassiumHigh: Bool {return self._bloodpotassiumHigh != nil}
  /// Clears the value of `bloodpotassiumHigh`. Subsequent reads from it will return its default value.
  mutating func clearBloodpotassiumHigh() {self._bloodpotassiumHigh = nil}

  var bloodpotassiumBelow: Float {
    get {return _bloodpotassiumBelow ?? 0}
    set {_bloodpotassiumBelow = newValue}
  }
  /// Returns true if `bloodpotassiumBelow` has been explicitly set.
  var hasBloodpotassiumBelow: Bool {return self._bloodpotassiumBelow != nil}
  /// Clears the value of `bloodpotassiumBelow`. Subsequent reads from it will return its default value.
  mutating func clearBloodpotassiumBelow() {self._bloodpotassiumBelow = nil}
  ...
  fileprivate var _enable: Bool? = nil
  fileprivate var _bloodpotassiumHigh: Float? = nil
  fileprivate var _bloodpotassiumBelow: Float? = nil
}

struct BpCaliConf: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct AfConf: Sendable {
  ...
  var rriSingleTime: Bool {
    get {return _rriSingleTime ?? false}
    set {_rriSingleTime = newValue}
  }
  /// Returns true if `rriSingleTime` has been explicitly set.
  var hasRriSingleTime: Bool {return self._rriSingleTime != nil}
  /// Clears the value of `rriSingleTime`. Subsequent reads from it will return its default value.
  mutating func clearRriSingleTime() {self._rriSingleTime = nil}
  ...
  fileprivate var _interval: UInt32? = nil
  fileprivate var _rriSingleTime: Bool? = nil
}

struct FemalHealthConf: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct PeerInfoNotification: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var bloodSugarAlarmConf: BloodsugarAlarmConf {
    get {return _storage._bloodSugarAlarmConf ?? BloodsugarAlarmConf()}
    set {_uniqueStorage()._bloodSugarAlarmConf = newValue}
  }
  /// Returns true if `bloodSugarAlarmConf` has been explicitly set.
  var hasBloodSugarAlarmConf: Bool {return _storage._bloodSugarAlarmConf != nil}
  /// Clears the value of `bloodSugarAlarmConf`. Subsequent reads from it will return its default value.
  mutating func clearBloodSugarAlarmConf() {_uniqueStorage()._bloodSugarAlarmConf = nil}

  var bloodPotassiumAlarmConf: BloodpotassiumAlarmConf {
    get {return _storage._bloodPotassiumAlarmConf ?? BloodpotassiumAlarmConf()}
    set {_uniqueStorage()._bloodPotassiumAlarmConf = newValue}
  }
  /// Returns true if `bloodPotassiumAlarmConf` has been explicitly set.
  var hasBloodPotassiumAlarmConf: Bool {return _storage._bloodPotassiumAlarmConf != nil}
  /// Clears the value of `bloodPotassiumAlarmConf`. Subsequent reads from it will return its default value.
  mutating func clearBloodPotassiumAlarmConf() {_uniqueStorage()._bloodPotassiumAlarmConf = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  enum PeerType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  enum PeerStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
...
extension BloodsugarAlarmConf: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "BloodsugarAlarmConf"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "enable"),
    2: .standard(proto: "Bloodsugar_highr"),
    3: .standard(proto: "Bloodsugar_below"),
  ]

  public var isInitialized: Bool {
    if self._enable == nil {return false}
    if self._bloodsugarHighr == nil {return false}
    if self._bloodsugarBelow == nil {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self._enable) }()
      case 2: try { try decoder.decodeSingularFloatField(value: &self._bloodsugarHighr) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self._bloodsugarBelow) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._bloodsugarHighr {
      try visitor.visitSingularFloatField(value: v, fieldNumber: 2)
    } }()
    try { if let v = self._bloodsugarBelow {
      try visitor.visitSingularFloatField(value: v, fieldNumber: 3)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: BloodsugarAlarmConf, rhs: BloodsugarAlarmConf) -> Bool {
    if lhs._enable != rhs._enable {return false}
    if lhs._bloodsugarHighr != rhs._bloodsugarHighr {return false}
    if lhs._bloodsugarBelow != rhs._bloodsugarBelow {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension BloodpotassiumAlarmConf: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "BloodpotassiumAlarmConf"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "enable"),
    2: .standard(proto: "Bloodpotassium_high"),
    3: .standard(proto: "Bloodpotassium_below"),
  ]

  public var isInitialized: Bool {
    if self._enable == nil {return false}
    if self._bloodpotassiumHigh == nil {return false}
    if self._bloodpotassiumBelow == nil {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self._enable) }()
      case 2: try { try decoder.decodeSingularFloatField(value: &self._bloodpotassiumHigh) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self._bloodpotassiumBelow) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._bloodpotassiumHigh {
      try visitor.visitSingularFloatField(value: v, fieldNumber: 2)
    } }()
    try { if let v = self._bloodpotassiumBelow {
      try visitor.visitSingularFloatField(value: v, fieldNumber: 3)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: BloodpotassiumAlarmConf, rhs: BloodpotassiumAlarmConf) -> Bool {
    if lhs._enable != rhs._enable {return false}
    if lhs._bloodpotassiumHigh != rhs._bloodpotassiumHigh {return false}
    if lhs._bloodpotassiumBelow != rhs._bloodpotassiumBelow {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension AfConf: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "RRI_Single_time"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularBoolField(value: &self._rriSingleTime) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._rriSingleTime {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 4)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: AfConf, rhs: AfConf) -> Bool {
    ...
    if lhs._interval != rhs._interval {return false}
    if lhs._rriSingleTime != rhs._rriSingleTime {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension PeerInfoNotification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    17: .standard(proto: "Blood_sugar_alarm_conf"),
    18: .standard(proto: "Blood_potassium_alarm_conf"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _bloodSugarAlarmConf: BloodsugarAlarmConf? = nil
    var _bloodPotassiumAlarmConf: BloodpotassiumAlarmConf? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _bloodSugarAlarmConf = source._bloodSugarAlarmConf
      _bloodPotassiumAlarmConf = source._bloodPotassiumAlarmConf
    }
  }
  ...
  public var isInitialized: Bool {
    return withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._bloodSugarAlarmConf, !v.isInitialized {return false}
      if let v = _storage._bloodPotassiumAlarmConf, !v.isInitialized {return false}
      return true
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 17: try { try decoder.decodeSingularMessageField(value: &_storage._bloodSugarAlarmConf) }()
        case 18: try { try decoder.decodeSingularMessageField(value: &_storage._bloodPotassiumAlarmConf) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._bloodSugarAlarmConf {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 17)
      } }()
      try { if let v = _storage._bloodPotassiumAlarmConf {
  ...
  static func ==(lhs: PeerInfoNotification, rhs: PeerInfoNotification) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._bloodSugarAlarmConf != rhs_storage._bloodSugarAlarmConf {return false}
        if _storage._bloodPotassiumAlarmConf != rhs_storage._bloodPotassiumAlarmConf {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
